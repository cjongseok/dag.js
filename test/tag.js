...
describe('Tag Operation Test', () =>{
    describe('DAG(order=4, size=4)', () => {
        ...
        it('should filter by a tag, "friend"', () => {
            let filtered = dag.filterByTag('friend');
            // test it
//            filtered.deep.equal(dag);
        ...
        it('should filter by a tag, "follows"', () => {
            let filtered = dag.filterByTag('follows');
        ...
        it('should not fileter by a tag, "parent"', () => {
            expect(dag.filterByTag('parent')).to.be.undefined;
        });
    });
});
